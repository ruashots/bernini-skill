...
3. **Reference images: 1–2 is the sweet spot.** The model separates subjects well with 1–2 refs; **past 2, identity separation and quality drop** (a documented model limitation). For multiple subjects, name them in order — refs are exposed as `image0`, `image1`, … positionally.
